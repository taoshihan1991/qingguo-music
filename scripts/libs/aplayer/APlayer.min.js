    ...
    var e = []
      , t = function() {
        function t(e) {
            ...
            for (var i in s)
                s.hasOwnProperty(i) && !e.hasOwnProperty(i) && (e[i] = s[i]);
            this.playIndex = "[object Array]" === Object.prototype.toString.call(e.music) ? 0 : -1,
            this.option = e,
            this.audios = [],
            this.loop = !0,
            ...
            this.parseLrc = function(e) {
                for (var t = [], a = 0; a < e.length; a++) {
                    for (var s = e[a].split("\n"), i = [], l = s.length, n = 0; l > n; n++) {
                        ...
                        if (null  != o)
                            for (var u = o.length, d = 0; u > d; d++) {
                                var p = /\[(\d{2}):(\d{2})\.(\d{2,3})]/.exec(o[d])
                                  , m = 60 * p[1] + parseInt(p[2]) + parseInt(p[3]) / (2 === (p[3] + "").length ? 100 : 1e3);
                                i.push([m, r])
                            }
                    }
                    i.sort(function(e, t) {
            ...
            ,
            this.updateBar = function(e, t, s) {
                t = t > 0 ? t : 0,
                t = 1 > t ? t : 1,
                a[e + "Bar"].style[s] = 100 * t + "%"
            }
            ,
            this.updateLrc = function() {
                var e = arguments.length <= 0 || void 0 === arguments[0] ? a.audio.currentTime : arguments[0];
                if (a.lrcIndex > a.lrc.length - 1 || e < a.lrc[a.lrcIndex][0] || !a.lrc[a.lrcIndex + 1] || e >= a.lrc[a.lrcIndex + 1][0])
                    for (var t = 0; t < a.lrc.length; t++)
                        e >= a.lrc[t][0] && (!a.lrc[t + 1] || e < a.lrc[t + 1][0]) && (a.lrcIndex = t,
                        a.lrcContents.style.transform = "translateY(" + 20 * -a.lrcIndex + "px)",
                        a.lrcContents.style.webkitTransform = "translateY(" + 20 * -a.lrcIndex + "px)",
                        a.lrcContents.getElementsByClassName("aplayer-lrc-current")[0].classList.remove("aplayer-lrc-current"),
                        a.lrcContents.getElementsByTagName("p")[t].classList.add("aplayer-lrc-current"))
            }
        }
        return _createClass(t, [{
            ...
            value: function() {
                function t(e) {
                    for (var t = e.offsetLeft, a = e.offsetParent, s = void 0; null  !== a; )
                        t += a.offsetLeft,
                        a = a.offsetParent;
                    return s = document.body.scrollLeft + document.documentElement.scrollLeft,
                    t - s
                }
                function a(e) {
                    for (var t = e.offsetTop, a = e.offsetParent, s = void 0; null  !== a; )
                        t += a.offsetTop,
                        a = a.offsetParent;
                    return s = document.body.scrollTop + document.documentElement.scrollTop,
                    t - s
                }
                var s = this;
                    ...
                    if (1 === this.option.showlrc)
                        if (this.multiple)
                            for (i = 0; i < this.option.music.length; i++)
                                l.push(this.option.music[i].lrc);
                        else
                            l.push(this.option.music.lrc);
                    else if (2 === this.option.showlrc || this.option.showlrc === !0)
                ...
                if (this.multiple) {
                    ...
                    i = 0; i < this.option.music.length; i++)
                ...
                this.button.addEventListener("click", function(e) {
                    s.button.classList.contains("aplayer-play") ? s.play() : s.button.classList.contains("aplayer-pause") && s.pause()
                }
                ),
                this.multiple && !function() {
                    for (var e = s.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li"), t = function(t) {
                        e[t].addEventListener("click", function() {
                            var a = parseInt(e[t].getElementsByClassName("aplayer-list-index")[0].innerHTML) - 1;
                            a !== s.playIndex && s.setMusic(a),
                            s.play()
                        }
                        )
                    }
                    , a = 0; a < s.option.music.length; a++)
                        t(a)
                }
                (),
                ...
                this.bar.addEventListener("click", function(e) {
                    ...
                    o = s.bar.clientWidth;
                    var i = (a.clientX - t(s.bar)) / o;
                    s.updateBar("played", i, "width"),
                    s.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = s.secondToTime(i * s.audio.duration),
                    s.audio.currentTime = parseFloat(s.playedBar.style.width) / 100 * s.audio.duration
                }
                ),
                this.thumb.addEventListener("mouseover", function() {
                    s.thumb.style.background = s.option.theme
                }
                ),
                this.thumb.addEventListener("mouseout", function() {
                    s.thumb.style.background = "#fff"
                }
                );
                var r = function(e) {
                    var a = e || window.event
                      , i = (a.clientX - t(s.bar)) / o;
                    i = i > 0 ? i : 0,
                    i = 1 > i ? i : 1,
                    s.updateBar("played", i, "width"),
                    s.option.showlrc && s.updateLrc(parseFloat(s.playedBar.style.width) / 100 * s.audio.duration),
                    s.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = s.secondToTime(i * s.audio.duration)
                }
                  , u = function h() {
                ...
                var d = this.element.getElementsByClassName("aplayer-volume-bar")[0]
                  , p = this.element.getElementsByClassName("aplayer-time")[0].getElementsByTagName("i")[0]
                  , m = 35;
                this.element.getElementsByClassName("aplayer-volume-bar-wrap")[0].addEventListener("click", function(e) {
                    ...
                    i = i > 0 ? i : 0,
                    i = 1 > i ? i : 1,
                    s.updateBar("volume", i, "height"),
                    s.audio.volume = i,
                    s.audio.muted && (s.audio.muted = !1),
                    1 === i ? p.className = "demo-icon aplayer-icon-volume-up" : p.className = "demo-icon aplayer-icon-volume-down"
                }
                ),
                p.addEventListener("click", function() {
                    s.audio.muted ? (s.audio.muted = !1,
                    p.className = 1 === s.audio.volume ? "demo-icon aplayer-icon-volume-up" : "demo-icon aplayer-icon-volume-down",
                    s.updateBar("volume", s.audio.volume, "height")) : (s.audio.muted = !0,
                    p.className = "demo-icon aplayer-icon-volume-off",
                    s.updateBar("volume", 0, "height"))
                }
                );
                var c = this.element.getElementsByClassName("aplayer-icon-loop")[0];
                c.addEventListener("click", function() {
                    s.loop ? (c.classList.add("aplayer-noloop"),
                    s.loop = !1,
                    s.audio.loop = s.multiple ? !1 : s.loop) : (c.classList.remove("aplayer-noloop"),
                    s.loop = !0,
                    s.audio.loop = s.multiple ? !1 : s.loop)
                }
                ),
                this.multiple && this.element.getElementsByClassName("aplayer-icon-menu")[0].addEventListener("click", function() {
                    var e = s.element.getElementsByClassName("aplayer-list")[0];
            ...
            value: function(e) {
                ...
                if (this.music = this.multiple ? this.option.music[a] : this.option.music,
                this.music.pic && (this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url(" + encodeURI(this.music.pic) + ")"),
                ...
                this.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li")[a].classList.add("aplayer-list-light")),
                this.audio && (this.pause(),
                this.audio.currentTime = 0),
                this.multiple && !this.audios[a] || -1 === this.playIndex ? (this.audio = document.createElement("audio"),
                ...
                this.audio.loop = this.multiple ? !1 : this.loop,
                this.multiple && (this.audios[a] = this.audio)) : (this.audio = this.audios[a],
                this.audio.volume = parseInt(this.element.getElementsByClassName("aplayer-volume")[0].style.height) / 100,
                this.audio.currentTime = 0),
                this.option.showlrc) {
            ...
            value: function() {
                ...
                if (this.audio.paused) {
                    ...
                    setTimeout(function() {
                        t.button.innerHTML = '<i class="demo-icon aplayer-icon-pause"></i>'
                    }
                    , 100),
                    this.option.mutex)
                    ...
                    this.playedTime = setInterval(function() {
                        ...
                        t.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = t.secondToTime(t.audio.currentTime)
                    }
                    , 100)
                }
            }
            ...
            value: function() {
                var e = this;
                this.audio.paused || (this.button.classList.remove("aplayer-pause"),
